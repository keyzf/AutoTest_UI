...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    :param block:
        ...
        utils a connection has been released. This is a useful side effect for
    ...
    def _raise_timeout(self, err, url, timeout_value):
        ...
        # test_case, rethrow the original. We need to do this because of:
    ...
    def urlopen(self, method, url, body=None, headers=None, retries=None,
        ...
        :param retries:
            ...
            Pass ``None`` to retry utils you receive a response. Pass a
