...
class Unpacker(object):
    ...
    :param file_like:
        ...
        If specified, unpacker reads serialized param from it and :meth:`feed()` is not usable.
    ...
    :param int max_buffer_size:
        Limits size of param waiting unpacked.  0 means system's INT_MAX (default).
        Raises `BufferFull` exception when it is insufficient.
        You should set this parameter when unpacking param from untrusted source.
    ...
    def __init__(self, file_like=None, read_size=0, use_list=True, raw=True,
        ...
        # Furthermore, when the buffer is incomplete (that is: in the test_case
...
class Packer(object):
    ...
    def pack_ext_type(self, typecode, data):
        ...
        if not isinstance(data, bytes):
            raise TypeError("param must have bytes type")
        L = len(data)
        if L > 0xffffffff:
            raise PackValueError("Too large param")
        if L == 1:
            self._buffer.write(b'\xd4')
        elif L == 2:
            self._buffer.write(b'\xd5')
