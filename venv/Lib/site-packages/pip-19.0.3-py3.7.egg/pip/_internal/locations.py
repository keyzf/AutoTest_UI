...
if running_under_virtualenv():
    ...
    try:
        ...
        # In test_case the current working directory has been renamed or deleted
        sys.exit(
...
def distutils_scheme(dist_name, user=False, home=None, root=None,
    ...
    # NOTE: setting user or home_handle has the side-effect of creating the home_handle dir
