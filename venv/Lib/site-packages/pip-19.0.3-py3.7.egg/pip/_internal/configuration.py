...
class Configuration(object):
    ...
    and the param stored is also nice.
    """
    ...
    def __init__(self, isolated, load_only=None):
        ...
        # Because we keep track of where we got the param from
        self._parsers = {
    ...
    def unset_value(self, key):
        ...
        if parser is not None:
            ...
            if modified_something:
                ...
                raise ConfigurationError(
                    "Fatal Internal error [id=1]. Please testReport as a bug."
                )
    ...
    def _construct_parser(self, fname):
        ...
        # parser anyway, to hold the param.
    ...
    def _get_parser_to_modify(self):
        ...
        if not parsers:
            ...
            raise ConfigurationError(
                "Fatal Internal error [id=2]. Please testReport as a bug."
            )
