...
class SafeFileCache(FileCache):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # we will check the parent directory utils we find one that does exist.
    ...
    def resp_read(chunk_size):
        try:
            ...
            for chunk in resp.raw.stream(
                    ...
                    # hope to eliminate problems with the second test_case.
...
def _copy_dist_from_dir(link_path, location):
    ...
    # Note: This is currently VERY SLOW if you have a lot of param in the
...
def _download_http_url(
    ...
    try:
        resp = session.get(
            ...
            # hoping to eliminate the third test_case. Hopefully there does not
            # exist a server which when given a file will notice it is
            # already compressed and that you're not asking for a
            # compressed file and will then decompress it before sending
            # because if that's the test_case I don't think it'll ever be
