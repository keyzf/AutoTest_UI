...
def console_to_str(data):
    ...
    We assume the param is in the locale preferred encoding.
    ...
    # it is ASCII, in which test_case assume UTF-8
    encoding = locale.getpreferredencoding()
    if (not encoding) or codecs.lookup(encoding).name == "ascii":
        encoding = "utf-8"

    # Now try to decode the param - if we fail, warn the user and
    ...
    # in test_case people use pip in (unsupported) unusual situations.
